...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                'leads' => \App\GraphQL\Queries\LeadsQuery::class,
            ],
            'mutation' => [
                'createLead' => \App\GraphQL\Mutations\CreateLeadMutation::class,
                'deleteLead' => \App\GraphQL\Mutations\DeleteLeadMutation::class,
                'updateLead' => \App\GraphQL\Mutations\UpdateLeadMutation::class,
            ],
            'types' => [
